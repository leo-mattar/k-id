...
function clientMarquee() {
  ...
  let tl = gsap.timeline({
    defaults: { ease: "none", repeat: -1, duration: marquerDuration },
  });
...
//   // Check if the current domain matches the domains where you want to tweak the value
//   if (
//     (window.location.hostname === "k-id-development.webflow.io" &&
//       window.location.pathname.endsWith("/ja")) ||
//     (window.location.hostname === "k-id.com" &&
//       window.location.pathname.endsWith("/ja"))
//   ) {
//     // Update the yOffset for the specific domain
//     yOffset = "20em";
//     console.log("ja detected");
//   }
